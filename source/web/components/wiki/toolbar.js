   ...
   */
   ...
   Alfresco.WikiToolbar.prototype =
   {
      ...
      onReady: function WikiToolbar_onReady()
      {
         ...
         // Check the delete button actually exists on the page first
         if(document.getElementById(this.id + "-delete-button")) {
         ...
         this.widgets.markForDeleteButton = Alfresco.util.createYUIButton(this, "mark-for-delete-button", this.onMarkForDeleteClick,
         {
            disabled: true,
            value: "edit"
         });
         
         this.widgets.removeDeleteMarkButton = Alfresco.util.createYUIButton(this, "remove-delete-mark-button", this.onRemoveDeleteMarkClick,
         {
            disabled: true,
            value: "edit"
         });
         
         this.widgets.unDeleteMarkButton = Alfresco.util.createYUIButton(this, "undelete-button", this.onUndeleteClick,
         {
            disabled: true,
            value: "edit"
         });
         
         this.widgets.deleteNowButton = Alfresco.util.createYUIButton(this, "delete-now-button", this.onDeleteNowClick,
         {
            disabled: true,
            value: "edit"
         });
      ...
      /**
       * onRemoveDeleteMarkClick
       * Mark the current item for delete
       */
      onMarkForDeleteClick : function()
      {
        ...
        var markForDeleteFail = function()
        {
      	...
      	var pageTitle = YAHOO.util.Selector.query('.pageTitle')[0].innerHTML.replace(/ /g,'_');
      	var siteName = Alfresco.constants.SITE;
      	var path = '/app:company_home/st:sites/cm:'+siteName+'/cm:wiki/cm:'+encodeURIComponent(pageTitle);
      ...
      /**
       * Remove any delete marks from the current item
       */
      onRemoveDeleteMarkClick : function()
      {
    	  
    	var onRemoveDeleteMarkOK = function()
        {
          self.location.href=self.location.href;
        };
          
        var onRemoveDeleteMarkFail = function()
        {
          alert('An error occurred while attempting to mark this item for delete.  If the error persists, please contact support');
        };
          ...
          Alfresco.util.Ajax.request(
                  {
                      ...
                      successCallback :
                        {
                    	  fn: onRemoveDeleteMarkOK,
                          scope: this
                        },
                      failureCallback :
                        {
                  	      fn: onRemoveDeleteMarkFail,
                          scope: this
                        },
                      scope: this
                  });
      ...
      /**
       * Undelete the current item
       */
      onUndeleteClick : function()
      {
    	  
    	var onUndeleteOK = function()
        {
    	  alert("This wiki page has been undeleted and moved back to it's original site");
          self.location.href=self.location.href.replace(/wiki-page.*/g, 'wiki');;
        };
          
        var onUndeleteFail = function()
        {
          alert('An error occurred while attempting to mark this item for delete.  If the error persists, please contact support');
        };
      ...
      /**
       * Archive the page right now
       */
      onDeleteNowClick : function()
      {
    	  
    	var onDeleteNowOK = function()
        {
    	  alert("This wiki page has been archived into the Deleted Items site");
          self.location.href=self.location.href.replace(/wiki-page.*/g, 'wiki');;
        };
          
        var onDeleteNowFail = function()
        {
          alert('An error occurred while attempting to mark this item for delete.  If the error persists, please contact support');
        };
