 ...
 * @return {string} an html link pointing to the user profile.
 */
Alfresco.util.people.generateUserLinkWithPresence = function generateUserLink(person, presence)
{
   return Alfresco.thirdparty.presence.getPresenceIndicatorHtml(person.username, Alfresco.util.people.generateUserDisplayName(person), presence);
};
 ...
 * 
 * Modified to use the Surevine redirecting avatar service
 * 
...
{
	   var avatarUrl = Alfresco.constants.PROXY_URI + '/sv-theme/user-profile/avatar?user=' + person.username;
