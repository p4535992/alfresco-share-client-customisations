...
(function()
{
   ...
   Alfresco.doclib.Actions.prototype =
   {
       ...
       * @method onActionManagePermissions
       * @param assets
       *            {object} Object literal representing one or more file(s)
       *            or folder(s) to be actioned
       */
      onActionManagePermissionsBasic: function dlA_onActionManagePermissionsBasic(assets)
      {
