...
function loadActivityData()
{
  ...
  Alfresco.util.Ajax.request(
    {
      url: Alfresco.constants.PROXY_URI + "/sv-theme/activities?format=html",
      method: "GET",
...
function setActivityContent(content) {
    var body = YAHOO.util.Selector.query('div[id=activities-dashlet-body]')[0];
...
<div class="dashlet">
   ...
   <div id="activities-dashlet-body" class="body scrollableList" <#if args.height??>style="height: ${args.height}px;"</#if>>
      Loading data...
   </div>
</div>
